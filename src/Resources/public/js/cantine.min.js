'use strict';jQuery("document").ready(function(a){let n=function(){console.clear();console.log("Maj de la liste des Repas");a("#loading").show();let d={action:"getListeRepas",date:a("input#date").val()};""!=a("select#nomClasse").val()&&(d.classe=a("select#nomClasse").val());""!=a("select#nomEtablissement").val()&&(d.etablissement=a("select#nomEtablissement").val());a.ajax({url:"/ajax.html",data:d,type:"POST",success:function(c){c=a.parseJSON(c);"error"==c.result?alert("Erreur Ajax : "+c.details.msg):
