...
{1==c.isConfirmed&&a.ajax({url:"/ajax.html",data:{action:"majPaiement",item:b,choix:c.value},type:"POST",success:function(e){"error"==a.parseJSON(e).result?alert("erreur"):document.location.href=document.location.href}})})});a("input[name=dateDebut]").on("change",function(){let d=moment(this.value),b=moment(this.value);d.date(1);b.endOf("month");this.value=d.format("YYYY-MM-DD");a("input[name=dateFin]").val(b.format("YYYY-MM-DD"))})});